...
const VERSION:String = "alpha_dev"	## version number for SceneManager+
...
var _loading_screen_scene= preload("res://scenes/UserInterface/loading_screen.tscn")	## reference to loading screen PackedScene
